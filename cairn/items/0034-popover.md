...
Shared positioning and dismissal for Menu, Select and Tooltip. Use CSS anchor positioning where supported, with the behaviour layer's positioning as fallback.
